...
<main> 
	<header><h2><%=titulo %></h2> </header>	
		...
		<div>
			...
			<input value="<%=alumno.getNombre()%>" type="text" placeholder="Introduzca su nombre.." name="<%=Constantes.PAR_NOMBRE %>" id="<%=Constantes.PAR_NOMBRE %>">
		</div>
		<div>
			<label for="<%=Constantes.PAR_APELLIDOS%>">Apellidos:</label>
			<input value="<%=alumno.getApellidos()%>" type="text" placeholder="Introduzca sus apellidos.." name="<%=Constantes.PAR_APELLIDOS %>" id="<%=Constantes.PAR_APELLIDOS %>">
		</div>
		<div>
			<label for="<%=Constantes.PAR_DNI%>">DNI:</label>
			<input value="<%=alumno.getDni()%>" type="text" placeholder="Introduzca su DNI.." name="<%=Constantes.PAR_DNI %>" id="<%=Constantes.PAR_DNI %>">
		</div>
		<div>
			<label for="<%=Constantes.PAR_EMAIL%>">Email:</label>
			<input value="<%=alumno.getEmail()%>" type="email" placeholder="Introduzca su email.." name="<%=Constantes.PAR_EMAIL %>" id="<%=Constantes.PAR_EMAIL %>">
		</div>
		<div>
			<label for="<%=Constantes.PAR_DIRECCION%>">Dirección:</label>
			<input value="<%=alumno.getDireccion()%>" type="text" placeholder="Introduzca su email.." name="<%=Constantes.PAR_DIRECCION %>" id="<%=Constantes.PAR_DIRECCION %>">
		</div>
		<%
		String date = "";
		...
		<div>
			...
			<input value="<%=date%>" type="text" placeholder="Introduzca su fecha de nacimiento.." name="<%=Constantes.PAR_FNACIMIENTO %>" id="<%=Constantes.PAR_FNACIMIENTO %>">
		</div>
		<div>
		...
		<div>
			...
			%>
				...
				<option selected value="0">Desctivado </option>
			<%
			}
			%>
			</select>
