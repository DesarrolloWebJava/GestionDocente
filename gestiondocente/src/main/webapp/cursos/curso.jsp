...
<main>
	...
	<div class="form-group">
		...
		value="<%=curso.getNombre()%>"  placeholder="Introduce el nombre" >
	</div>
	
	<div class="form-group">
		<label for="<%=Constantes.PAR_HORAS %>">Duración del curso</label>
		<input type="text" class="form-control" id="<%=Constantes.PAR_HORAS %>" name="<%=Constantes.PAR_HORAS %>"
   ...
   <%
	...
	%>
	<div class="form-group">
		<label for="<%=Constantes.PAR_FFINAL %>">Fecha de Fin</label>
		<input type="text" class="form-control" id="<%=Constantes.PAR_FFINAL %>" name="<%=Constantes.PAR_FFINAL%>" 
