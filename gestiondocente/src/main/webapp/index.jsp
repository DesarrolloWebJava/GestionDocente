...
<fmt:message key="index.mensaje"/> <fmt:message key="index.nombreApp"/>
	<form action=<%=Constantes.SERVLET_LOGIN%> method="post">
   	<input name=<%=Constantes.PAR_USUARIO%> type="text" placeholder="<fmt:message key="index.login.username"/>"></br>
   	<input name=<%=Constantes.PAR_PASSWORD%> type="password" placeholder="<fmt:message key="index.login.password"/>"></br>
   	...
   	<select id="<%=Constantes.PAR_IDIOMA%>" name="<%=Constantes.PAR_IDIOMA%>">
   		<option selected value="<%=Constantes.IDIOMA_CASTELLANO%>"><fmt:message key="idioma.castellano"/></option>
