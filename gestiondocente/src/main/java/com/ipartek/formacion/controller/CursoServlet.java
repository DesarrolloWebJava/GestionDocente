...
public class CursoServlet extends HttpServlet {
	...
	private Curso recogerParametros(HttpServletRequest request) throws Exception {
		...
		try {
			String duracion = request.getParameter(Constantes.PAR_HORAS);
